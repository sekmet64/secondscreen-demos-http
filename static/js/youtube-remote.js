...
$(document).ready(function(){
  ...
  socket.emit('connect-remote', { uniqueId: uniqueId });
...
function setPlaying() {
  ...
  $('.now-playing-overlay').attr('src', 'static/images/pause64.png');
}

function setPaused() {
  playing = false;
  $('.now-playing-overlay').attr('src', 'static/images/play64.png');
}